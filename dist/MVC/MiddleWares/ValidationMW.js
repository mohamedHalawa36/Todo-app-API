...
module.exports = function (req, res, next) {
    ...
    if (result.errors.length != 0) {
        let errorString = result.errors.reduce((current, errorObj) => {
...
module.exports.createUserValidations = [
    ...
    body("password")
        ...
        .matches(/^(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%^&*()-_+=])[A-Za-z0-9!@#\$%^&*()-_+=]{8,}$/)
        .withMessage("password should be at least 8 characters, containing a capital letter and a number and a special character"),
];
